...
const ComponentMount: React.StatelessComponent<IComponentMountProps> = (
  props: IComponentMountProps
) => {
  ...
  switch (props.type) {
    ...
    case "embed":
      ...
      break;
    default:
      toMountComponent = <div>Select a Component to edit</div>;
  }
  const isActive: boolean =
    props.activeCol && props.activeCol.id === props.colId;
