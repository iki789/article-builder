...
import {
  ...
  UPDATE_MARGINS,
  UPDATE_THEME,
} from "../Preview/store/actions";
import "./GlobalSettings.scss";
import FontSettings, { IFonts } from "../../components/Settings/Fonts/Fonts";
import MarginSettings, {
  IMargins,
} from "../../components/Settings/Margins/Margins";
    ...
    const settingComponents = (
      <div className="mt-5">
        <Row>
          <Col className="mb-4">
            <FontSettings
              fonts={this.props.previewState.settings.fonts}
        ...
        <Row>
          <Col className="mb-4">
            <MarginSettings
              margins={this.props.previewState.settings.margins}
        ...
        <Row>
          <Col className="mb-4">
            ...
            <ColorPicker
              color={this.props.previewState.settings.theme}
          ...
          <Col className="mb-4">
            ...
            <div>
              <Button
                size="sm"
                className="mr-2"
                onClick={this.handleHtmlExport}
              >
                HTML
              </Button>
              {this.state.HtmlReqestBusy ? (
                <img
                  src={LoadingIcon}
                  width="15px"
                  style={{ margin: "0 15px" }}
